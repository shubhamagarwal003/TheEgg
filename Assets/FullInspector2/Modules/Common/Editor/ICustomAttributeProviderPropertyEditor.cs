...
namespace FullInspector.Modules.Common {
    ...
    public class ICustomAttributeProviderPropertyEditor : PropertyEditor<ICustomAttributeProvider> {
        public override float GetElementHeight(GUIContent label, ICustomAttributeProvider element) {
            return EditorStyles.label.CalcHeight(label, Screen.width);
        }

        public override ICustomAttributeProvider Edit(Rect region, GUIContent label, ICustomAttributeProvider element) {
