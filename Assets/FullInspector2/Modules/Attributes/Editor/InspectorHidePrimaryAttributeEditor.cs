...
namespace FullInspector.Modules.Attributes {
    ...
    public class InspectorHidePrimaryAttributeEditor<T> :
        ...
        protected override T Edit(Rect region, GUIContent label, T element, InspectorHidePrimaryAttribute attribute) {
            return element;
        }

        protected override float GetElementHeight(GUIContent label, T element, InspectorHidePrimaryAttribute attribute) {
            return 0;
        }
    }
}