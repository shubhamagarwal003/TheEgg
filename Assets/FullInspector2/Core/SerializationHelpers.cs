...
namespace FullInspector {
    public static class SerializationHelpers {
        ...
        public static T DeserializeFromContent<T, TSerializer>(string content)
            ...
            var notSupportedOperator = SingletonCache.Get<NotSupportedSerializationOperator>();

            return (T)serializer.Deserialize(typeof(T), content, notSupportedOperator);
        }
        ...
        public static string SerializeToContent<T, TSerializer>(T value)
            ...
            return serializer.Serialize(typeof(T), value, notSupportedOperator);
        }
        ...
        public static T Clone<T, TSerializer>(T obj)
            ...
            var serializer = SingletonCache.Get<TSerializer>();
            var serializationOperator = SingletonCache.Get<ListSerializationOperator>();
            serializationOperator.SerializedObjects = new List<UnityObject>();

            string serialized = serializer.Serialize(typeof(T), obj, serializationOperator);
            object deserialized = serializer.Deserialize(typeof(T), serialized, serializationOperator);
