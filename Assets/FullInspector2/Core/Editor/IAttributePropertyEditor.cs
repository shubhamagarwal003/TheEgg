...
namespace FullInspector {
    ...
    public abstract class AttributePropertyEditor<TElement, TAttribute> :
        ...
        object IPropertyEditorEditAPI.Edit(Rect region, GUIContent label, object element) {
            ...
            return Edit(region, label, (TElement)element, _attribute);
        }
        ...
        float IPropertyEditorEditAPI.GetElementHeight(GUIContent label, object element) {
            ...
            return GetElementHeight(label, (TElement)element, _attribute);
        }
        ...
        protected virtual TElement Edit(Rect region, GUIContent label, TElement element, TAttribute attribute) {
            var nextEditor = EditorChain.GetNextEditor(this);
            return PropertyEditorExtensions.Edit(nextEditor, region, label, element);
        }
        protected virtual float GetElementHeight(GUIContent label, TElement element, TAttribute attribute) {
            var nextEditor = EditorChain.GetNextEditor(this);
