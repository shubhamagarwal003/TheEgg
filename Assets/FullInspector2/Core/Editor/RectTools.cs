...
namespace FullInspector.Internal {
    ...
    public static class RectTools {
        ...
        /// <summary>
        /// Splits the rect into two horizontal ones, with the right rect set to an exact width.
        /// </summary>
        /// <param name="rect">The rect to split.</param>
        /// <param name="rightWidth">The width of the right rect.</param>
        ...
        public static void SplitHorizontalExact(Rect rect, float rightWidth, float margin,
            out Rect left, out Rect right) {

            left = rect;
            right = rect;

            left.width -= rightWidth + margin / 2;

            right.x += left.width + margin;
            right.width = rightWidth - margin / 2;
        }
