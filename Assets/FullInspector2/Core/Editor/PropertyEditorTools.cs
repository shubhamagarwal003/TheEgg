...
namespace FullInspector.Internal {
    public static class PropertyEditorTools {
        ...
        private static bool TryCreateInstance(Type editorType, Type usedEditedType,
            Type actualEditedType, out IPropertyEditor editor) {
        ...
        /// <returns></returns>
        private static IPropertyEditor TryCreateSpecificEditor(Type usedEditedType, Type actualEditedType, Type editorType) {
            //-
            //-
            //-
            ...
            // we have to construct a closed generic editor type
                ...
                try {
                    Type createdEditor = editorType.MakeGenericType(usedEditedType.GetGenericArguments());
                    IPropertyEditor editor;
                    if (TryCreateInstance(createdEditor, usedEditedType, actualEditedType, out editor)) {
                        return editor;
                    }
                ...
                try {
                    ...
                    arguments.AddRange(usedEditedType.GetGenericArguments());
        ...
        public static IPropertyEditor TryCreateEditor(Type editedType, Type editorType) {
            ...
            while (baseType != null) {
                IPropertyEditor editor = TryCreateSpecificEditor(baseType, editedType, editorType);
                if (editor != null) {
                    return editor;
                }
