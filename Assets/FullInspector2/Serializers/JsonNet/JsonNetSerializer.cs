...
namespace FullInspector {
    public class JsonNetSerializer : BaseSerializer {
        ...
        internal override string Serialize(MemberInfo storageType, object value,
            ISerializationOperator serializationOperator) {

            try {
                Settings.Context = new StreamingContext(StreamingContextStates.All, serializationOperator);
                ...
                Settings.Context = new StreamingContext();
            }
        }

        internal override object Deserialize(MemberInfo storageType, string serializedState,
            ISerializationOperator serializationOperator) {
