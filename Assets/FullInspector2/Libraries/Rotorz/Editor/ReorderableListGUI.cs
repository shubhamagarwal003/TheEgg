...
namespace FullInspector.Rotorz.ReorderableList {
    ...
    public static class ReorderableListGUI {
        ...
        /// <returns>Unmodified value of list item.</returns> <typeparam name="T">Type of list
        /// item.</typeparam>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Null values are automatically changed to empty strings since null values cannot be
        /// edited using a text field.</para> <para>Value of <c>GUI.changed</c> is set to
        /// <c>true</c> if value of item is modified.</para>
        /// </remarks>
        /// <param name="position">Position to draw list item control(s).</param>
        /// <param name="item">Value of list item.</param>
        /// <returns>Modified value of list item.</returns>
        ...
        /// <param name="fixedItemHeight">Use fixed height for items rather than see
        /// cref="UnityEditor.EditorGUI.GetPropertyHeight(SerializedProperty)"/>.</param>
        /// <param name="drawEmpty">Callback to draw custom content for empty list
        /// (optional).</param>
        /// <param name="flags">Optional flags to pass into list field.</param>
