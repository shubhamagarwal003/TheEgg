...
namespace FullInspector.Rotorz.ReorderableList {
    ...
    /// </summary>
    /// <remarks>
    /// <para>This adaptor can be subclassed to add special logic to item height calculation. You
    /// may want to implement a custom adaptor class where specialised functionality is
    /// needed.</para>
    /// </remarks>
    public class SerializedPropertyAdaptor : IReorderableListAdaptor {
        ...
        /// </summary>
        /// <remarks>
        /// <para>Non-zero value overrides property drawer height calculation which is more
        /// efficient.</para>
        /// </remarks>
        ...
        /// <returns>Serialized property wrapper for array element.</returns>
        ...
        /// <param name="fixedItemHeight">Non-zero height overrides property drawer height
        /// calculation.</param>
